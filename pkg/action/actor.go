...
func (ac *Actor) Act(ctx context.Context, calls []Call) ([]percept.Percept, error) {
	...
	for i, call := range calls {
		ac.log.Debug("iterate tool calls", "method", "Act", "num", i)
...
func (ac *Actor) act(ctx context.Context, call Call) (percept.Percept, error) {
	ac.log.Debug("execute call to the tool service", "method", "act", "toolName", call.Name)
	...
	resp, err := ac.transport.Post(ctx, tool.Addr.String(), header, strings.NewReader(call.Arguments))
	if err != nil {
